        ...
        <motion.svg width="100%" height="100%" id="svg" viewBox="0 0 1440 1200" xmlns="http://www.w3.org/2000/svg"
          ...
          <defs>
            <linearGradient id="gradient" x1="0%" y1="50%" x2="100%" y2="50%">
              <stop offset="5%" stopColor="#878787"></stop>
              <stop offset="95%" stopColor="#878787"></stop>
            </linearGradient>
          </defs>
          <path
            ...
            stroke="none" strokeWidth="0" fill="url(#gradient)" fillOpacity="0.2"
          ...
          <path
            ...
            stroke="none" strokeWidth="0" fill="url(#gradient)" fillOpacity="0.20"
